...
flowchart TB
  ...
  style BLOCK fill:#f0dfd9,stroke:#a03b31,color:#1e1c19
  style ONLINE fill:#e2ebdf,stroke:#3e7247,color:#1e1c19
  style GRADE fill:#eae4d6,stroke:#2f6154,color:#1e1c19
```
...
flowchart LR
  ...
  GATE -->|任一端红或无签字| NO[阻断]
  style NO fill:#f0dfd9,stroke:#a03b31,color:#1e1c19
  style OK fill:#e2ebdf,stroke:#3e7247,color:#1e1c19
```
