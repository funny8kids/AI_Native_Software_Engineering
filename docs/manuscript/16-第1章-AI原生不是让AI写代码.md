...
把这三条根因画成一张对照图，冲突会更直观——同一次采购，装不装刹车，走向两条完全不同的曲线：
...
flowchart TB
  ...
  style D1 fill:#fef2f2,stroke:#dc2626,color:#1a1d23
  style E fill:#ecfdf5,stroke:#059669,color:#1a1d23
```

**图 1-2｜油门与刹车** — 只装油门，速度与事故一起涨；装上刹车，速度才敢继续涨。
...
三类边界要能被机器判定，才会从墙上的清单变成流水线里的门禁——它长这样：
...
flowchart TB
  ...
  style A3 fill:#fef2f2,stroke:#dc2626,color:#1a1d23
  style A2 fill:#fef3c7,stroke:#d97706,color:#1a1d23
```
