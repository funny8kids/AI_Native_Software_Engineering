...
flowchart LR
  ...
  CI --> IMPL[实现 / AI 代码]
  IMPL -.必须对齐.-> REPO
  style REV fill:#f8efdf,stroke:#9d6127,color:#1e1c19
  style REPO fill:#f1ece1,stroke:#2f6154,color:#1e1c19
```
...
flowchart LR
  ...
  style CI fill:#f1ece1,stroke:#2f6154,color:#1e1c19
  style WAIT fill:#f8efdf,stroke:#9d6127,color:#1e1c19
...
flowchart LR
  ...
  style CLS fill:#f8efdf,stroke:#9d6127,color:#1e1c19
  style RISK fill:#f1ece1,stroke:#2f6154,color:#1e1c19
  style MULTI fill:#f1ece1,stroke:#2f6154,color:#1e1c19
```
