...
| ch06-第1章-AI原生不是让AI写代码 | 5 | 1-1、1-2、1-3、1-4、1-5 | flowchart |
| ch07-第2章-人在回路 | 4 | 2-1、2-2、2-3、2-4 | flowchart/state |
| ch08-第3章-人机分工 | 5 | 3-1、3-2、3-3、3-4、3-5 | flowchart/sequence |
| ch09-第4章-AI原生工程栈 | 5 | 4-1、4-2、4-3、4-4、4-5 | flowchart/gantt |
| ch10-第5章-大规模考古画图 | 4 | 5-1、5-2、5-3、5-4 | flowchart |
| ch11-第6章-跨团队依赖分析 | 4 | 6-1、6-2、6-3、6-4 | flowchart |
| ch12-第7章-AI读懂祖传代码 | 4 | 7-1、7-2、7-3、7-4 | flowchart/state |
| ch13-第8章-目标架构 | 4 | 8-1、8-2、8-3、8-4 | flowchart |
| ch14-第9章-契约先行 | 5 | 9-1、9-2、9-3、9-4、9-5 | flowchart |
| ch15-第10章-边界变测试 | 4 | 10-1、10-2、10-3、10-4 | flowchart |
| ch16-第11章-留缝 | 4 | 11-1、11-2、11-3、11-4 | flowchart |
| ch17-第12章-数据与日志分家 | 5 | 12-1、12-2、12-3、12-4、12-5 | flowchart |
| ch18-第13章-单文件API到router+nginx | 4 | 13-1、13-2、13-3、13-4 | flowchart |
| ch19-第14章-Python立包与迁移 | 3 | 14-1、14-2、14-3 | flowchart/state |
| ch20-第15章-前端解耦多端设计系统 | 4 | 15-1、15-2、15-3、15-4 | flowchart |
| ch21-第16章-聊天功能 | 5 | 16-1、16-2、16-3、16-4、16-5 | flowchart/sequence |
| ch22-第17章-多端BFF | 5 | 17-1、17-2、17-3、17-4、17-5 | flowchart |
| ch23-第18章-亿级流量 | 5 | 18-1、18-2、18-3、18-4、18-5 | flowchart/sequence/state |
...
| ch27-第22章-安全合规公开仓库 | 5 | 22-1、22-2、22-3、22-4、22-5 | flowchart/sequence |
| ch28-第23章-提示词工程与归档 | 5 | 23-1、23-2、23-3、23-4、23-5 | flowchart |
| ch29-第24章-AI评审与幻觉处理 | 4 | 24-1、24-2、24-3、24-4 | flowchart/sequence |
| ch30-第25章-文档ADR-RFC-设计令牌治理 | 5 | 25-1、25-2、25-3、25-4、25-5 | flowchart/state |
| ch31-第26章-组织治理 | 5 | 26-1、26-2、26-3、26-4、26-5 | flowchart/state |
...
```text
手稿 43 个文件 / 181 张图；站点页 3 张；合计 184 张。
正文图引用 387 条 / 全书图注 184 条（唯一编号 184 个）/ 悬空与撞号 0 条。
BOOK_SPEC §9 校验通过：每章 2–5 张、图号递增、图注与图一一对应、节点 ≤12、正文图引用全部可解析、图注编号全书唯一。

```

42 个 `chNN-` 文件全部落在 2–5 张区间：2 张 4 个、3 张 2 个、4 张 14 个、5 张 22 个（顶到 §9 上限的是第 1、3、4、9、12、16、17、18、19、20、21、22、23、25、26、27、28 这 17 章，加上四个案例章与附录 J，共 22 个文件）。**这一句由那张表派生，不再手抄**：2026-09-26 第九轮起，重打这一节的脚本直接从 `check_figures.py --print` 的输出里数分桶、点顶格章，改完正文只需重跑那条命令与这个脚本，两边一起动。为什么值得为它做一次派生：这一句在手抄的年代就错过账——同日拿同一口径回量 HEAD 那一份表，3 张那一桶表里是 7 个文件，句子里写着 8 个；差一只桶的整句作废，重派即对。（2026-09-25 补附录那四份文件各加 1–3 张图，手稿从 150 涨到 159，随后案例四再补两张到 161、案例一与案例三各补两张到 165、第 26 章组织治理再补两张到 167（2026-09-26）、第九轮三章各补一到两张到 171、第十轮第 10 章与第 25 章各补一张到 173、第十一轮第 11 章与第 16 章各补一张到 175、第十二轮第 6 章与第 17 章各补一张到 177、第十三轮第 2/19/23 章补写零新增图（额度已满，三处新表只点名既有图号）、第十四轮第 12 章补一张到 178（第 21 章额度已满，同样零新增）、第十五轮第 13 章补一张到 179（第 9 章额度已满，零新增）、第十六轮第 7 章与第 22 章各补一张到 181（两章本轮都还有额度，各用掉一张），每一次都是先重跑命令再改这两处读数的）。`manuscript/README.md` 是书稿总览页（1 张骨架图），九个 `part-*.md` 卷首页用位图艺术开场——两者都不是章，不参与「2–5 张」判定，由守卫按同一口径跳过。
...
python3 scripts/check_markdown.py                     # 第三条：分支清单以该脚本 docstring 为准——本行不抄分支名册（上一版抄的四项早已比实际分支少，抄件在加分支当天静默失真）
python3 scripts/check_markdown.py --selftest           # 第三条的桩件自检：闸数与条数由这条命令自己打印（每闸一段 ✔），这里不写死计数
